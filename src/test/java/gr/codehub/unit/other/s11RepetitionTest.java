...
class s11RepetitionTest {
    ...
    //Honestly, this is a dummy retry annotation. It just retries your unit without checking their results,
    // in order to add some logic and retry the unit when they are failing, you should add rerunner-jupiter dependency
    // in your pom.xml
